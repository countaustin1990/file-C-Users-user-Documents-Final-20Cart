        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="flex justify-center mb-4">
              <FaTshirt className={`text-5xl ${isDarkMode ? 'text-indigo-300' : 'text-indigo-500'}`} />
            </div>
          ...
          >
            <div className="flex justify-center mb-4">
              <FaShippingFast className={`text-5xl ${isDarkMode ? 'text-indigo-300' : 'text-indigo-500'}`} />
            </div>
          ...
          <div
            className={`shadow-lg p-6 rounded-lg transform hover:scale-105 transition duration-300 ${
              isDarkMode ? 'bg-gray-800 hover:bg-slate-300 hover:text-gray-800' : 'bg-gray-200 hover:bg-slate-700'
            }`}
          >
            <div className="flex justify-center mb-4">
              <FaCheckCircle className={`text-5xl ${isDarkMode ? 'text-indigo-300' : 'text-indigo-500'}`} />
            </div>
