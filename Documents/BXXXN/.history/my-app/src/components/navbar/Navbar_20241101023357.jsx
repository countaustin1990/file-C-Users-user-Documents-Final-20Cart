    ...
    <nav className={`navbar ${theme === 'light' ? 'bg-white text-black' : 'bg-gray-800 text-white'} transition-colors duration-300`}>
      ...
      {isMenuOpen && (
        <ul className={`md:hidden p-4 space-y-2 ${theme === 'light' ? 'bg-white text-black' : 'bg-gray-800 text-white'}`}>
          <li><Link to="home" className="block font-bold" onClick={handleLinkClick}>Home</Link></li>
          <li><Link to="about" className="block font-bold" onClick={handleLinkClick}>About</Link></li>
          <li><Link to="services" className="block font-bold" onClick={handleLinkClick}>Services</Link></li>
          <li><Link to="contact" className="block font-bold" onClick={handleLinkClick}>Contact</Link></li>
        </ul>
      )}
    </nav>
  );
