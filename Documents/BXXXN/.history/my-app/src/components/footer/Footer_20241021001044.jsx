...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-green-700 to-green-600 text-white p-16">
      <div className="w-full max-w-full p-4 text-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="flex items-center space-x-5 text-center"  onClick={scrollToTop}>
              {/* Add Logo if necessary */}
              <span className="text-xl font-bold capitalize tracking-wide text-center">
                Orthopedic Clinic
              </span>
            </Link>
