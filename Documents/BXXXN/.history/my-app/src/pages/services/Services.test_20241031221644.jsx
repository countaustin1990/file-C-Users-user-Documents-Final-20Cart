...
import customTailoringImage from './assets/images/custom-tailoring.jpg'; // Adjust the path based on your project structure
...
const Services = ({ theme }) => {
  const services = [
    { 
      ...
      imageUrl: customTailoringImage // Use the imported image here
    },
    { 
